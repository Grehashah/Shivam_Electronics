        ...
        <div class="card">
          <div class="body">
            ...
            <div class="row m-t-15 m-b--20">
              <div class="col-xs-6">
                <a href="/sign-up" class="hvr-push">Register Now!</a>
              </div>
              <div class="col-xs-6 align-right">
                <a href="/forgotpwd" class="hvr-push">Forgot Password?</a>
              </div>
            </div>
          </div>
        </div>
...
import sin1 from "../../services/user/signin_service";
...
export default {
        ...
        sin1
          ...
          .then(res => {
            ...
            if (resdata.result == -1) {
                ...
                sin1
                  ...
                  .then(res => {
                    ...
                    if (resdata.result == -1) {
                      ...
                      this.error = "Check your mail for your new password";
                      this.count = 0;
                      var data3 = {
                        email: this.email,
                        pwd: this.pwd,
              ...
              if (this.remember != "") {
                this.$cookies.set("Email", this.email, 60 * 60 * 24 * 30);
                this.$cookies.set("Pass", this.pwd, 60 * 60 * 24 * 30);
              }
              this.$session.start();
  ...
  beforeMount() {
    ...
    if (this.$cookies.isKey("Email")) {
      ...
      this.pwd = this.$cookies.get("Pass");
    }
  }
};
</script>
