...
const orders = require('../../models/subadmin/manageOrders');
...
router.get('/employee/newOrders', (req, res, next) => {
...
router.get('/employee/acceptedOrders', (req, res, next) => {
...
router.get('/employee/canceledOrders', (req, res, next) => {
...
router.get('/employee/completedOrders', (req, res, next) => {
...
router.get('/employee/underShipmentOrders', (req, res, next) => {
...
router.get('/employee/rejectedOrders', (req, res, next) => {
...
router.post('/employee/order/accept', (req, res, next) => {
...
router.post('/employee/order/reject', (req, res, next) => {
...
router.post('/employee/order/underShipment', (req, res, next) => {
...
router.post('/employee/order/complete', (req, res, next) => {
...
router.post('/employee/order/orderDetails', (req, res, next) => {
...
router.get('/employee/order/customerDetails/:choice', (req, res, next) => {
...
router.get('/employee/order/addressDetails/:choice', (req, res, next) => {
...
router.post('/employee/order/productDetails', (req, res, next) => {
...
router.post('/employee/order/uploadInvoice', upload, (req, res, next) => {
...
router.post('/employee/order/updateInvoice', upload, (req, res, next) => {
