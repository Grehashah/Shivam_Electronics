...
const manage = require('../../models/admin/manageProduct');
...
router.get('/admin/product/fan/list', (req, res, next) => {
...
router.get('/admin/product/fridge/list', (req, res, next) => {
...
router.get('/admin/product/mixer/list', (req, res, next) => {
...
router.get('/admin/product/speaker/list', (req, res, next) => {
...
router.get('/admin/product/tv/list', (req, res, next) => {
...
router.get('/admin/product/flourmil/list', (req, res, next) => {
...
router.get('/admin/product/iron/list', (req, res, next) => {
...
router.get('/admin/product/oven/list', (req, res, next) => {
...
router.get('/admin/product/washingmachine/list', (req, res, next) => {
...
router.get('/admin/product/waterpurifier/list', (req, res, next) => {
...
router.get('/admin/product/mobile/list', (req, res, next) => {
...
router.delete('/admin/deleteproduct/fan/:id', (req, res, next) => {
...
router.delete('/admin/deleteproduct/tv/:id', (req, res, next) => {
...
router.delete('/admin/deleteproduct/mobile/:id', (req, res, next) => {
...
router.delete('/admin/deleteproduct/flourmil/:id', (req, res, next) => {
...
router.delete('/admin/deleteproduct/speaker/:id', (req, res, next) => {
...
router.delete('/admin/deleteproduct/waterpurifier/:id', (req, res, next) => {
...
router.delete('/admin/deleteproduct/oven/:id', (req, res, next) => {
...
router.delete('/admin/deleteproduct/iron/:id', (req, res, next) => {
...
router.delete('/admin/deleteproduct/mixer/:id', (req, res, next) => {
...
router.delete('/admin/deleteproduct/washingmachine/:id', (req, res, next) => {
...
router.delete('/admin/deleteproduct/fridge/:id', (req, res, next) => {
...
router.post('/admin/addproduct/fan', (req, res, next) => {
...
router.post('/admin/addproduct/flourmil', (req, res, next) => {
...
router.post('/admin/addproduct/mixer', (req, res, next) => {
...
router.post('/admin/addproduct/washingmachine', (req, res, next) => {
...
router.post('/admin/addproduct/waterpurifier', (req, res, next) => {
...
router.post('/admin/addproduct/speaker', (req, res, next) => {
...
router.post('/admin/addproduct/iron', (req, res, next) => {
...
router.post('/admin/addproduct/oven', (req, res, next) => {
...
router.post('/admin/addproduct/tv', (req, res, next) => {
...
router.post('/admin/addproduct/mobile', (req, res, next) => {
...
router.post('/admin/addproduct/fridge', (req, res, next) => {
...
router.get('/admin/manageproduct/brands', (req, res, next) => {
...
router.post('/admin/getproduct/fan', (req, res, next) => {
...
router.post('/admin/getproduct/tv', (req, res, next) => {
...
router.post('/admin/getproduct/oven', (req, res, next) => {
...
router.post('/admin/getproduct/iron', (req, res, next) => {
...
router.post('/admin/getproduct/mixer', (req, res, next) => {
...
router.post('/admin/getproduct/waterpurifier', (req, res, next) => {
...
router.post('/admin/getproduct/washingmachine', (req, res, next) => {
...
router.post('/admin/getproduct/speaker', (req, res, next) => {
...
router.post('/admin/getproduct/flourmil', (req, res, next) => {
...
router.post('/admin/getproduct/mobile', (req, res, next) => {
...
router.post('/admin/getproduct/fridge', (req, res, next) => {
...
router.post('/admin/updateproduct/fan', (req, res, next) => {
...
router.post('/admin/updateproduct/fridge', (req, res, next) => {
...
router.post('/admin/updateproduct/mixer', (req, res, next) => {
...
router.post('/admin/updateproduct/washingmachine', (req, res, next) => {
...
router.post('/admin/updateproduct/waterpurifier', (req, res, next) => {
...
router.post('/admin/updateproduct/iron', (req, res, next) => {
...
router.post('/admin/updateproduct/oven', (req, res, next) => {
...
router.post('/admin/updateproduct/tv', (req, res, next) => {
...
router.post('/admin/updateproduct/mobile', (req, res, next) => {
...
router.post('/admin/updateproduct/flourmil', (req, res, next) => {
...
router.post('/admin/updateproduct/speaker', (req, res, next) => {
...
router.post('/admin/uploadFanImage', fanupload, (req, res, next) => {
...
router.post('/admin/uploadFlourmilImage', flourmilupload, (req, res, next) => {
    const image = req.file;
    if (!image) {
        res.send({
            result: -1
...
router.post('/admin/uploadMobileImage', mobileupload, (req, res, next) => {
    const image = req.file;
    if (!image) {
        res.send({
            result: -1
...
router.post('/admin/uploadSpeakerImage', speakerupload, (req, res, next) => {
    const image = req.file;
    if (!image) {
        res.send({
            result: -1
...
router.post('/admin/uploadTVImage', tvupload, (req, res, next) => {
    const image = req.file;
    if (!image) {
        res.send({
            result: -1
...
router.post('/admin/uploadWashingMachineImage', washingmachineupload, (req, res, next) => {
    const image = req.file;
    if (!image) {
        res.send({
            result: -1
...
router.post('/admin/uploadWaterPurifierImage', waterpurifierupload, (req, res, next) => {
    const image = req.file;
    if (!image) {
        res.send({
            result: -1
...
router.post('/admin/uploadMixerImage', mixerupload, (req, res, next) => {
    const image = req.file;
    if (!image) {
        res.send({
            result: -1
...
router.post('/admin/uploadIronImage', ironupload, (req, res, next) => {
    const image = req.file;
    if (!image) {
        res.send({
            result: -1
...
router.post('/admin/uploadOvenImage', ovenupload, (req, res, next) => {
    const image = req.file;
    if (!image) {
        res.send({
            result: -1
...
router.post('/admin/uploadFridgeImage', fridgeupload, (req, res, next) => {
    const image = req.file;
    if (!image) {
        res.send({
            result: -1
