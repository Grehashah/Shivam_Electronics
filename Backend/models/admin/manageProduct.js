...
var item = {
    ...
    getMixer(callback) {
        return db.query('select t1.Status,t1.Capacity,t2.Name,t1.Price,t1.Color,t1.Model,t1.Ratings,t1.MixerID from tblmixer as t1 JOIN tblbrand as t2 ON t1.BrandID = t2.BrandID', callback);
    },
    getSpeaker(callback) {
        return db.query('select t1.Status,t1.Type,t2.Name,t1.Price,t1.Color,t1.Model,t1.Ratings,t1.SpeakerID from tblspeaker as t1 JOIN tblbrand as t2 ON t1.BrandID = t2.BrandID', callback);
    },
    ...
    getMixer1(data, callback) {
        return db.query('select t1.Status,t1.BrandID,t1.MixerID,t2.Name,t1.Price,t1.Image,t1.Capacity,t1.Warranty,t1.Quantity,t1.Ratings,t1.Color,t1.Model,t1.Details,t1.Discount from tblmixer as t1 JOIN tblbrand as t2 ON t1.BrandID = t2.BrandID where t1.MixerID = ?', [data.cid], callback);
    },
    getSpeaker1(data, callback) {
        return db.query('select t1.Status,t1.Quantity,t1.BrandID,t1.SpeakerID,t2.Name,t1.Image,t1.Price,t1.Type,t1.Warranty,t1.Ratings,t1.Color,t1.Model,t1.Details,t1.Discount from tblspeaker as t1 JOIN tblbrand as t2 ON t1.BrandID = t2.BrandID where t1.SpeakerID = ?', [data.cid], callback);
    },
