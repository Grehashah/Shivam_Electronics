        ...
        <div class="card">
          <div class="body">
            ...
            <div class="row m-t-15 m-b--20">
              <div class="col-xs-6">
                <a href="/admin-forgotpwd" class="hvr-push">Forgot Password?</a>
              </div>
            </div>
          </div>
        </div>
...
import sin1 from "../../services/admin/signin_service";
...
export default {
        ...
        sin1
          ...
          .then(res => {
            ...
            if (resdata.result == -1) {
              ...
              if (this.remember != "") {
                this.$cookies.set("admin-Email", this.email, 60 * 60 * 24 * 30);
                this.$cookies.set("admin-Pass", this.pwd, 60 * 60 * 24 * 30);
              }
              this.$session.start();
              this.$session.set("admin-email", this.email);
  ...
  beforeMount() {
    ...
    if (this.$cookies.isKey("admin-Email")) {
      this.email = this.$cookies.get("admin-Email");
      this.pwd = this.$cookies.get("admin-Pass");
    }
  }
};
</script>
